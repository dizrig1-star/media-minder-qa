...
const base=state.movies.filter(x=>!state.watched.includes(https://www.google.com/url?q=http://x.id&source=gmail&ust=1787998255162000&sa=E) && !state.notInterested.includes(https://www.google.com/url?q=http://x.id&source=gmail&ust=1787998255162000&sa=E));
