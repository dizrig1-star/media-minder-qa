...
export function Recommendations(state,choice,recs){
 ...
 ${gold.length?`<div class="grid-2">${gold.slice(0,4).map(x=>mediaCard(state,x)).join("")}`:"<div class='empty-state'>Nothing rates an MM Select Gold right now.</div>"}
