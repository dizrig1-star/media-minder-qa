...
export function Tonight(state,choice,recs){
 ...
 <div class="grid-2"><section class="stack editorial-stack">${picks.slice(0,4).map(x=>EditorialCard(x,platformName(state,x.platform),state.progress?.[x.id]?"watching":"tonight",state)).join("")}</section>
