...
export function Landing(state,choice,recs){
 ...
 <aside class="stack"><div class="card"><div class="page-kicker">Coming Soon</div><h3>Two Weeks</h3><p>New and returning series worth having on the radar.</p><button class="btn secondary" data-route="premieres">See premieres</button></div>
 <div class="card"><div class="page-kicker">Because You Liked...</div><h3>A little more of what works.</h3><p>Curated from your genres, franchises, favorite people and platforms.</p><button class="btn secondary" data-route="recommendations">See recommendations</button></div></aside></div>
