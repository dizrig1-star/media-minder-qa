...
const id = escapeHtml(https://www.google.com/url?q=http://item.id&source=gmail&ust=1787998255162000&sa=E);
const genres = (item.genre||[]).join(' · ');
const progress = (state.progress||{})[https://www.google.com/url?q=http://item.id&source=gmail&ust=1787998255162000&sa=E] || 0;
const rating = (state.ratings||{})[https://www.google.com/url?q=http://item.id&source=gmail&ust=1787998255162000&sa=E] || 0;
const inWatchlist = (state.watchlist||[]).includes(https://www.google.com/url?q=http://item.id&source=gmail&ust=1787998255162000&sa=E);
...
const isWatched = (state.watched||[]).includes(https://www.google.com/url?q=http://item.id&source=gmail&ust=1787998255162000&sa=E);
const isSkipped = (state.notInterested||[]).includes(https://www.google.com/url?q=http://item.id&source=gmail&ust=1787998255162000&sa=E);
...
${Rating(rating, true, https://www.google.com/url?q=http://item.id&source=gmail&ust=1787998255162000&sa=E)}
</div>
</div>
</div>
</article>`;
