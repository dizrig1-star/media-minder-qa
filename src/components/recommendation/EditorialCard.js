    ...
    <div class="editorial-card-inner">
      ...
      <div class="editorial-card-content">
        ...
        <div class="editorial-actions">
          ...
          <button class="btn small ${isWatched ? 'secondary' : 'ghost'}" data-watched="${id}">${isWatched ? 'Watched ✓' : 'Mark watched'}</button>
          <button class="btn small ${isSkipped ? 'secondary' : 'ghost'}" data-skip="${id}">${isSkipped ? 'Not for me ✓' : 'Not for me'}</button>
